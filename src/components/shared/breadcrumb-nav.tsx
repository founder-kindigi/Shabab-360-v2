...
const pageSectionMap: Partial<Record<PageId, BreadcrumbSection>> = {
  ...
  "admin-calling": { section: "Operations", sectionPage: null },
  "admin-calling-campaign-detail": { section: "Operations", sectionPage: null },
  "admin-calling-templates": { section: "Operations", sectionPage: null },
  "admin-mashwara": { section: "Operations", sectionPage: null },
  "admin-mashwara-detail": { section: "Operations", sectionPage: "admin-mashwara" },
  "admin-islah-mamulat": { section: "Operations", sectionPage: null },
