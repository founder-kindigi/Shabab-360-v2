                ...
                <CardContent className="px-4 pb-4 space-y-3">
                  ...
                  {p.dateOfBirth && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="font-medium">{calcAge(p.dateOfBirth)} years</span>
                      <span className="text-xs text-muted-foreground">
                        (DOB: {formatPKT(new Date(p.dateOfBirth))})
                      </span>
                    </div>
                  )}
                  {/* Address */}
              ...
              <Card>
                <CardHeader className="pb-2 px-4 pt-4">
                  <CardTitle className="text-xs font-medium text-muted-foreground uppercase tracking-wider flex items-center justify-between">
                    ...
                    <Button variant="link" className="text-[#4B0A8F] dark:text-[#8A40B0] h-auto p-0 text-[10px]">
                      View Full History
                ...
                <CardContent className="px-4 pb-4 space-y-3">
                  ...
                  <div className="grid grid-cols-4 gap-2 text-center">
                    <div>
                      <p className="text-lg font-bold text-emerald-600 dark:text-emerald-400">{att.present}</p>
                      <p className="text-[10px] text-muted-foreground">Present</p>
                    </div>
                    <div>
                      <p className="text-lg font-bold text-red-600 dark:text-red-400">{att.absent}</p>
                      <p className="text-[10px] text-muted-foreground">Absent</p>
                    </div>
                    <div>
                      <p className="text-lg font-bold text-amber-600 dark:text-amber-400">{att.late}</p>
                      <p className="text-[10px] text-muted-foreground">Late</p>
                    </div>
                    <div>
                      <p className="text-lg font-bold text-blue-600 dark:text-blue-400">{att.excused}</p>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-muted-foreground">
                        {att.totalEvents} total event{att.totalEvents !== 1 ? "s" : ""}
                      </span>
                      <span className="font-semibold">{att.rate}%</span>
                    </div>
