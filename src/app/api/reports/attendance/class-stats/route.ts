...
import { getClassStats } from "@/lib/attendance/summaries";
import {
  MAX_LIST_OFFSET,
  optionalDateOnly,
  optionalIdentifier,
...
export async function GET(request: Request) {
  ...
  const { groupId, parkId, cityId, from, to, limit, offset } = parseResult.data;
  ...
  try {
    ...
    console.error("Class stats API error:", error);
