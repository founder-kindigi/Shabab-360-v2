...
- **Scope:** Blank mobile browser UAT execution matrix converting 11 candidates from `UX-002` into structured test definitions, including device-specific viewports (375px/390px), expected visual evidence, pass/fail thresholds, severity levels, and UAT-005 screenshot naming.
