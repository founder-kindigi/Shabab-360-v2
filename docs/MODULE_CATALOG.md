...
| 4 | Organisation Setup | Manages cities, parks, venues, city-wide batches and park-specific groups. A group links one batch to one park in the same city. Supports active/inactive states, capacity and organisational history. | Program Head, City Head | Core structure exists; venue and history models need expansion |
