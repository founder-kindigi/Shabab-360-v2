...
- The owner accepted Attendance as complete for the current delivery phase on 2026-08-02. Browser/mobile UAT evidence remains a recommended operational follow-up rather than a release-blocking gate for this acceptance.
- Owner decision: configured batch off weekdays and one-off off dates are shared schedule policy. Attendance, Content Planner, Events, and future operational calendars must consume that policy rather than maintain module-specific off-day copies.
